...
const getHeaders = (requireToken) => {
  ...
  if (requireToken) {
    headers["x-token"] =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOiI2NDM0NTNkYjQ3ZjllNjc5MWQxM2JkNjAiLCJuYW1lIjoiRmFuaXNjYSIsImlhdCI6MTY4MzY1ODM0Nn0.zZ4M0CJW1GmlnaISW8t9vXRSPNpqXvFBSBZJQZJMsyA";
  }
  return headers;
};
